...
//        $Image_Final_Name=$this->getImageName().time().'.'.$this->getRequestImage()->getClientOriginalExtension();
...
//        return $Image_Final_Name;
    ...
    public function uploadeImages(){
        ...
        {
            $Image_Final_Name=$this->getImageName().time().$i.'.'.$image->getClientOriginalExtension();
...
//{
//$name=$coverimagename.$i.$image->getClientOriginalName();
//$image->move(public_path().'/carsimage/'.$request->input('nameen') .'/', $name);
//$data[] = $name;
//$i++;
//}
//}
